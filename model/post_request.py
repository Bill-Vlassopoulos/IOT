...
# http://150.140.186.118:1026/v2/entities/v3_omada14_fanari_0
...
for diastavrosi_id in range(0, max_diastavroseis):
    lista_apo_fanaria = []
    for i in range(0, 4):
        lista_apo_fanaria.append("v3_omada14_fanari_" + str(fanari_id))
        #### fanari creation
        data = {
            "id": "v3_omada14_fanari_" + str(fanari_id),
            "type": "TrafficLight",
        ...
        fanari_id += 1
    data = {
        "id": "v3_omada14_diastavrosi_" + str(diastavrosi_id),
        "type": "v3_omada14_diastavrosi",
        ...
        "orange_duration": {"type": "Integer", "value": 2},
        "gap_duration": {"type": "Integer", "value": 2},
        "period": {"type": "StructuredValue", "value": {"duration": "60"}},
        "mode": {"type": "Integer", "value": 0},  # 0 when dynamic and 1 when fixed
        "fixed_schedule": {
            "type": "StructuredValue",
            "value": [
                {lista_apo_fanaria[0]: 0},
                {lista_apo_fanaria[1]: 0},
                {lista_apo_fanaria[2]: 0},
                {lista_apo_fanaria[3]: 0},
            ],
        },
        "ptl": {"type": "Integer", "value": 0},
    }
