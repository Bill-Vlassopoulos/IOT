...
for i in range(5):
    SUBSCRIPTION_PAYLOAD = {
        "description": f"v2_omada14_diastavrosi_{i}",
        "subject": {
            "entities": [
                {
                    "idPattern": f"v2_omada14_diastavrosi_{i}",
                    "typePattern": "v2_omada14_diastavrosi",
                },
            ]
        },
        "notification": {
            "mqtt": {
                "url": "mqtt://150.140.186.118:1883",
                "topic": f"v2_fanaria/v2_omada14_diastavrosi_{i}",
            }
        },
    }
